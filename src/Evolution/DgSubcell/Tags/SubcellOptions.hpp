...
/// \brief System-agnostic options for DG-subcell
///
/// \note The blocks on which subcell is forbidden are not part of these
/// options; see `evolution::dg::Tags::OnlyDgBlockIds`.
