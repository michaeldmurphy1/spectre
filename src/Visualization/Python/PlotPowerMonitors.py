...
def plot_sw_power_monitors(
    ...
    return _plot_sh_power_monitors_impl(
        ...
        fixed_y_limits=fixed_y_limits,
        figsize=figsize,
        title="SW power monitors at observation {obs_id}",
    )
...
@click.option(
    ...
    help=(
        ...
        "detected from the H5 file (GH: SpacetimeMetric/Pi/Phi; SW: "
...
@click.option(
    ...
    default="Psi",
    show_default=True,
    help="Volume-data tensor name for the SW Psi.",
)
@click.option(
    "--sh-pi",
    default="Pi",
    ...
    **kwargs,
    ...
    if sh:
        ...
        if detected_system == "gh":
            ...
            assert detected_system == "sw"
            plot_fn = plot_sw_power_monitors
            plot_kwargs = dict(psi_name=sh_psi, pi_name=sh_pi, phi_name=sh_phi)
